...
const AccountSettings = () => {
  const { companyName, setCompanyName, name, setName, lastName, setLastName, phone, setPhone, email, setEmail, address, setAddress, edit } = useContext(AccountSettingsContext);
